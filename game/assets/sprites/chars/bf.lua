return graphics.newSprite(
	...
	},
	{
		...
		["down miss"] = {start = 28, stop = 30, speed = 24, offsetX = 0, offsetY = 0},
		["left"] = {start = 8, stop = 10, speed = 24, offsetX = 0, offsetY = 0},
		["left miss"] = {start = 22, stop = 24, speed = 24, offsetX = 0, offsetY = 0},
		["right"] = {start = 15, stop = 17, speed = 24, offsetX = 0, offsetY = 0},
		["right miss"] = {start = 25, stop = 27, speed = 24, offsetX = 0, offsetY = 0},
		["up"] = {start = 11, stop = 14, speed = 24, offsetX = 0, offsetY = 0},
		["up miss"] = {start = 31, stop = 33, speed = 24, offsetX = 0, offsetY = 0},
